...
class CWE(Generic):
  ...
  def transform(self, regime, regime_dict):
    ...
    # todo: fix problem with duplicate relationships, suspect it's due to different properties
...
MERGE (f)-[:HAS]->(n);""")
    ...
    for weakness_id in weaknesses.keys():
      ...
      # todo: decide what to do about platform mappings; they add A LOT of relationships
